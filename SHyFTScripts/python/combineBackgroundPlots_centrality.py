...
# ---------------------------------------------
# FIXME this needs to be the right sample!
f_ttbar = TFile('TTJets_HadronicMGDecays_8TeV-madgraph_'+inFileEnd+'.root')	## Summer12
f_zjets = TFile('DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_'+inFileEnd+'.root')
if not useDataQCD:
    # FIXME shitty QCD sample
    f_qcd   = TFile('QCD_Pt-15to3000_TuneZ2star_Flat_8TeV_pythia6_'+inFileEnd+'.root')
f_st_s  = TFile('T_s-channel_TuneZ2star_8TeV-powheg-tauola_'+inFileEnd+'.root')
f_st_t  = TFile('T_t-channel_TuneZ2star_8TeV-powheg-tauola_'+inFileEnd+'.root')
f_st_tW = TFile('T_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_'+inFileEnd+'.root')
f_stbar_s  = TFile('Tbar_s-channel_TuneZ2star_8TeV-powheg-tauola_'+inFileEnd+'.root')
f_stbar_t  = TFile('Tbar_t-channel_TuneZ2star_8TeV-powheg-tauola_'+inFileEnd+'.root')
f_stbar_tW = TFile('Tbar_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_'+inFileEnd+'.root')

if options.wjetsQ2Var is None :
	f_wjets = TFile('WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball_'+inFileEnd+'.root')
else :
	f_wjets = TFile('WJetsToLNu_' + options.wjetsQ2Var + '_8TeV-madgraph-tauola_'+inFileEnd+'.root')
