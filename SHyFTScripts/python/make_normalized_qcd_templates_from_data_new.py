...
for ijet in range(1,6):    
    ...
    targetHist = ihist + str(ijet) + 'j_ge1t'
    print "Reading from %s" % targetHist
...
if options.taggedHist.find( 'secvtxMass' ) > -1 :
    ...
    untaghists[3].SetName( 'proj_Data_muEta_4_0t')
    untaghists[4].SetName( 'proj_Data_muEta_5_0t')
